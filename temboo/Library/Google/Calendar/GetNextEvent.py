...
class GetNextEvent(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetNextEvent, self).__init__(temboo_session, '/Library/Google/Calendar/GetNextEvent')
...
class GetNextEventInputSet(InputSet):
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(GetNextEventInputSet, self)._set_input('AccessToken', value)
    def set_CalendarID(self, value):
        ...
        """
        super(GetNextEventInputSet, self)._set_input('CalendarID', value)
    def set_ClientID(self, value):
        """
        Set the value of the ClientID input for this Choreo. ((conditional, string) The Client ID provided by Google. Required unless providing a valid AccessToken.)
        """
        super(GetNextEventInputSet, self)._set_input('ClientID', value)
    def set_ClientSecret(self, value):
        """
        Set the value of the ClientSecret input for this Choreo. ((conditional, string) The Client Secret provided by Google. Required unless providing a valid AccessToken.)
        """
        super(GetNextEventInputSet, self)._set_input('ClientSecret', value)
    def set_RefreshToken(self, value):
        """
        Set the value of the RefreshToken input for this Choreo. ((conditional, string) An OAuth Refresh Token used to generate a new access token when the original token is expired. Required unless providing a valid AccessToken.)
        """
        super(GetNextEventInputSet, self)._set_input('RefreshToken', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) The format that response should be in. Can be set to xml or json. Defaults to json.)
        """
        super(GetNextEventInputSet, self)._set_input('ResponseFormat', value)
    def set_Timezone(self, value):
        ...
        """
        super(GetNextEventInputSet, self)._set_input('Timezone', value)
...
class GetNextEventResultSet(ResultSet):
    ...
    def get_EndTime(self):
        ...
        """
        return self._output.get('EndTime', None)
